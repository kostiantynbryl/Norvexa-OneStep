...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun completeOnboarding() {
        launch { repository.completeOnboarding() }
    }
    ...
    fun addStage(goalId: String, title: String) {
        launch { repository.addStage(goalId, title) }
    }
    ...
    fun deleteStep(goalId: String, stepId: String) {
        launch { repository.deleteStep(goalId, stepId) }
    }

    fun deleteStage(goalId: String, stageId: String) {
        launch { repository.deleteStage(goalId, stageId) }
    }
    ...
    fun activateGoal(goalId: String) {
        launch { repository.activateGoal(goalId) }
    }

    fun togglePause(goalId: String) {
        launch { repository.togglePause(goalId) }
    }

    fun deleteGoal(goalId: String) {
        launch { repository.deleteGoal(goalId) }
    }
    ...
    fun skipStep(goalId: String, stepId: String) {
        launch { repository.skipStep(goalId, stepId) }
    }

    fun postponeStep(goalId: String, stepId: String) {
        launch { repository.postponeStep(goalId, stepId) }
    }

    fun startStep(goalId: String, stepId: String) {
        launch { repository.startStep(goalId, stepId) }
    }

    fun splitStep(goalId: String, stepId: String) {
        launch { repository.splitStep(goalId, stepId) }
    }

    fun updateTheme(mode: ThemeMode) {
        launch { repository.updateTheme(mode) }
    }

    fun updateLanguage(tag: String) {
        launch { repository.updateLanguage(tag) }
    }

    fun updateReminders(enabled: Boolean) {
        launch { repository.updateReminders(enabled) }
    }

    fun exportJson(): String = repository.exportJson()

    fun importJson(raw: String, onResult: (Boolean) -> Unit) {
        viewModelScope.launch { onResult(repository.importJson(raw)) }
    }
